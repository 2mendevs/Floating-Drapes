...
export interface PortfolioItem {
  id: string;
  category: 'Living Room' | 'Bedroom' | 'Penthouse';
  title: string;
  description: string;
  beforeImage: string;
  afterImage: string;
...
export const PORTFOLIO_DATA: PortfolioItem[] = [
  {
    ...
    title: 'Royal Living Room Transformation',
  ...
  },
  {
    ...
    description: 'Replaced thin generic curtains with premium floor-to-ceiling Acoustic Velvet Blockouts and hand-painted silk wall coverings.',
  ...
  },
  {
    id: 'p3',
    category: 'Penthouse',
    title: 'Royal Penthouse Vista',
    description: 'Bespoke biophilic wall murals and warm sateen-lined flax linen drapes designed to frame breathtaking skyline views.',
