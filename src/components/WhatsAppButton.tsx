...
export default function WhatsAppButton() {
  const whatsappNumber = "918884009398";
  const defaultMessage = encodeURIComponent("Hi! I'm visiting Floating Drapes and would like to inquire about your luxury curtains, wallpapers, and blinds.");
  const directWhatsAppUrl = `https://wa.me/${whatsappNumber}?text=${defaultMessage}`;

  const handleClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    // Navigate straight to the user's WhatsApp with given phone number
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 font-sans" id="floating-whatsapp-widget">
      <motion.a
        ...
        title="Chat with us on WhatsApp (+91 88840 09398)"
